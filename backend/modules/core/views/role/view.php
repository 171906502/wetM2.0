...
<div class="bjui-pageContent">
    <form action="<?= Url::toRoute([$model->name?'update':'create','name'=>$model->name]) ?>" id="core-permission-view-form" data-toggle="validate" data-alertmsg="false" data-callback="myCallback">
        ...
        <table class="table table-condensed table-hover" width="100%">
            <tbody>
                <tr>
                    <td><label for="name" class="control-label x120">角色名称：</label> <input type="text" name="name" id="name" value="<?= $model->name; ?>" data-rule="required" size="15"></td>
                </tr>
                <tr>
                    <td><label for="description" class="control-label x120">角色描述：</label> <input type="text" name="description" id="description" value="<?= $model->description; ?>" data-rule="" size="15"></td>
                </tr>
                <tr>
